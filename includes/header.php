            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul style="position:relative;right: 70px;">
                            ...
                            <?php if(!isset($_SESSION['username'])) : ?>
                            <a style="top:3px;position:relative;" href="<?php echo APPURL; ?>/auth/login.php">LOGIN<span class="icon_profile"></span></a>
                        <?php endif; ?>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="col-lg-2">
                        ...
                        <form action="<?php echo APPURL; ?>/search.php" method="POST" class="form-inline my-2 my-lg-0">
                            ...
                            <button name="submit" style="color: red;background-color: #0b0c2a;outline: none;border-color: red;" class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                        </form>
                </div>
            </div>
        </div>
